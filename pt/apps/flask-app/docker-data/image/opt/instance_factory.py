...
class PythonRuntimeInstanceFactory(instance.InstanceFactory,
  ...
  def _RunPipInstall(cls, venv_dir, requirements_file_name):
    ...
    # os.system("cp -a /data/home/venv/bin/* {}/bin".format(venv_dir))
    # os.system("rm -rf {}/lib".format(venv_dir))
    # os.system("ln -s /data/home/venv/lib {}/lib".format(venv_dir))
    # os.system("cp -a /data/home/venv/lib/* {}/lib/".format(venv_dir))
